  ...
  <div class="ticket">
    ...
    <div class="ticket__info">
      ...
      <div class="ticket__row">
        ...
        <div class="ticket__info__item">
          <div class="ticket__label">Amount of tickets</div>
          <div class="ticket__value">{{ props.amount }}</div>
        </div>
      </div>
      <div class="ticket__line"></div>
      <div class="ticket__row">
      ...
      <div class="ticket__actions">
        <va-button @click="buyTicket" icon="shopping_cart" size="large" > Buy </va-button>
      </div>
